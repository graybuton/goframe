...
func TestParseInspectOptions(t *testing.T) {
	tests := []struct {
		...
		{name: "workspace split after path", args: []string{"app", "--workspace", "work"}, want: inspectOptions{path: "app", workspace: "work", format: inspectFormatText}},
		...
		{name: "format split after path", args: []string{"app", "--format", "json"}, want: inspectOptions{path: "app", format: inspectFormatJSON}},
		...
		{name: "format empty equals", args: []string{"app", "--format="}, wantError: "unsupported inspect format"},
		{name: "format empty split", args: []string{"app", "--format", ""}, wantError: "unsupported inspect format"},
		{name: "workspace missing value", args: []string{"app", "--workspace"}, wantError: "--workspace requires a value"},
		{name: "workspace empty equals", args: []string{"app", "--workspace="}, wantError: "--workspace requires a value"},
		{name: "workspace empty split after path", args: []string{"app", "--workspace", ""}, wantError: "--workspace requires a value"},
		{name: "workspace empty split before path", args: []string{"--workspace", "", "app"}, wantError: "--workspace requires a value"},
		{name: "directory missing value", args: []string{"--dir"}, wantError: "--dir requires a value"},
		{name: "directory empty equals", args: []string{"--dir="}, wantError: "--dir requires a value"},
		{name: "directory empty split after path", args: []string{"app", "--dir", ""}, wantError: "--dir requires a value"},
		{name: "directory empty split without path", args: []string{"--dir", ""}, wantError: "--dir requires a value"},
