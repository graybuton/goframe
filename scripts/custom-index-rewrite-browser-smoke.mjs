...
async function runManagedSpanTreeOracle() {
    const cases = [
        ...
        {
            name: "head mode duplicate html",
            source: `<html><head><html data-duplicate="yes"><!-- START --><!-- END --></head><body></body></html>`,
            sourceStartParent: "html", sourceEndParent: "html", sourceSameParent: true,
            startParent: "head", endParent: "head", startingContract: "rejected", finalContract: "rejected",
        },
        ...[
            { name: "base", element: `<base target="_blank">` },
            { name: "basefont", element: `<basefont color="red">` },
            { name: "bgsound", element: `<bgsound src="tone.wav">` },
            { name: "link", element: `<link rel="author" href="author.html">` },
            { name: "meta", element: `<meta name="fixture" content="yes">` },
            { name: "noframes", element: `<noframes></noframes>` },
            { name: "noscript", element: `<noscript></noscript>` },
            { name: "script", element: `<script></script>` },
            { name: "style", element: `<style></style>` },
            { name: "template", element: `<template></template>` },
            { name: "title", element: `<title>Authored</title>` },
        ].map(({ name, element }) => ({
            name: `head mode ${name}`,
            source: `<html><head>${element}<!-- START --><!-- END --></head><body></body></html>`,
            sourceStartParent: "head", sourceEndParent: "head", sourceSameParent: true,
            startParent: "head", endParent: "head", startingContract: "accepted", finalContract: "accepted",
        })),
        {
